  ...
  <q-page>
    ...
    >
      <template v-slot:top-left>
        <q-input outlined dense debounce="600" v-model="filter" placeholder="Buscar" style="min-width: 450px; max-width: 600px">
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      filter:'',
      ds_titulo: [
      { name: 'MICRO_RED', align: 'left', label: 'MICRO RED', field: 'nom_micro_red', sortable: true, headerStyle: {fontSize: '1.2em'},style: {fontSize: '1em'}},
      { name: 'EESS', align: 'left', label: 'ESTABLECIMIENTO', field: 'nom_establecimiento', sortable: true,headerStyle: {fontSize: '1.2em'},style: {fontSize: '1em'} },
      { name: 'META', align: 'right', label: 'META FISICA', field: 'meta_fisica', sortable: true,headerStyle: {fontSize: '1.2em'},style: {fontSize: '1em'} },
      ],
      cod_prg: null,
      cod_prd: null,
      cod_act: null,
